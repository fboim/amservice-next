      ...
      <div className="page-wrapper">
        <div className="page-container">
          ...
          <div className="pg-header fade-in">
            ...
            <Link href="/dashboard" className="am-btn am-btn-secondary am-btn-pill am-btn-sm">
          ...
          <div className="section-card fade-in" style={{ marginBottom: '20px' }}>
            <div style={{ padding: '16px 20px', display: 'flex', gap: '8px', flexWrap: 'wrap', alignItems: 'center' }}>
              ...
              {period === 'bulanan' && (
                <input
                  ...
                  className="am-input"
                  style={{ maxWidth: 160, padding: '6px 12px' }}
                />
              )}
          ...
          {/* Stats Grid */}
          <div className="dashboard-stats fade-in" style={{ marginBottom: '20px' }}>
            <div style={{
          ...
          {/* Omzet Card */}
          <div className="section-card fade-in" style={{ marginBottom: '20px', background: 'linear-gradient(135deg, rgba(139,92,246,.12) 0%, rgba(59,130,246,.12) 100%)', borderColor: '#8b5cf6' }}>
